...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\hp\PycharmProjects\instaBotProjectLearn\AI_EVM-main'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\hp\PycharmProjects\instaBotProjectLearn\AI_EVM-main\Scripts\deactivate.nu'
